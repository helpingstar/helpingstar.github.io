...
$\textbf{w}_{t+n} \doteq \textbf{w}_{t+n-1} + \alpha[G_{t:t+n}-\hat{v}(S_t, \textbf{w}_{t+n-1})]\nabla \hat{v}(S_t, \textbf{w}_{t+n-1}), \quad 0 \le t < T$
...
$\textbf{w}_{t+n} \doteq \textbf{w}_{t+n-1} + \alpha M_t[G_{t:t+n} - \hat{v}(S_t, \textbf{w}_{t+n-1})] \nabla \hat{v}(S_t, \textbf{w}_{t+n-1}), \quad 0 \le t < T$
